...
\shorttitle{Flow Experience and the Power Law of Practice}
...
\textbf{Word count (excluding  title, references, author affiliations, acknowledgements, figures and figure legends):} 9418}

% \textbf{Keywords:} Flow, Skill Acquisition, Power law of practice, Visuomotor performance, Steering, Eye blink rate, Negative Feedback, Dopamine
